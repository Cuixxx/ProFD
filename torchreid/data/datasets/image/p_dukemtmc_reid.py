...
class PDukemtmcReid(ImageDataset):
    ...
    def __init__(self, root='', masks_dir=None, **kwargs):
        ...
        self.train_dir=osp.join(self.dataset_dir, 'train_resize')
        self.query_dir=osp.join(self.dataset_dir, 'test_resize', 'occluded_body_images')
        self.gallery_dir=osp.join(self.dataset_dir, 'test_resize', 'whole_body_images')
