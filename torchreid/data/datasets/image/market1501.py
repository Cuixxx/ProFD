...
class Market1501(ImageDataset):
    ...
    def __init__(self, root='', market1501_500k=False, masks_dir=None, **kwargs):
        ...
        self.train_dir = osp.join(self.dataset_dir, 'bounding_box_train_resize')
        self.query_dir = osp.join(self.dataset_dir, 'query_resize')
        self.gallery_dir = osp.join(self.dataset_dir, 'bounding_box_test_resize')
    ...
    def process_dir(self, dir_path, relabel=False):
        ...
        for img_path in img_paths:
            ...
            # masks_path = self.infer_masks_path(img_path.replace('_resize',''))
