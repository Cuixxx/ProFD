...
from .random_erasing import CustomCoarseDropout
...
def build_transforms(
    ...
    **kwargs
    ...
    if 'random_flip' in transforms or 'rf' in transforms:
        print('+ random flip')
        transform_tr += [HorizontalFlip(p=0.5)]
    ...
    if 'random_erase' in transforms or 're' in transforms:
        print('+ random erase')
        transform_tr += [CustomCoarseDropout(min_holes=1, max_holes=1,
                                       min_height=int(height*0.15), max_height=int(height*0.57),
                                       min_width=int(width*0.15), max_width=int(width*0.57),
