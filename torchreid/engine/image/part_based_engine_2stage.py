...
class ImagePartBasedEngine2(Engine):
    ...
    def __init__(
        ...
        super(ImagePartBasedEngine2, self).__init__(config,
                                                   datamanager,
                                                   writer,
                                                   engine_state,
                                                   use_gpu=use_gpu,
    ...
    def forward_backward(self, data, epoch):
        ...
        loss, loss_summary = self.combine_losses_stage2(visibility_scores_dict,
                                                 embeddings_dict,
                                                 id_cls_scores_dict,
                                                 pids,
                                                 text_embeddings,
    ...
    def combine_losses_stage2(self, visibility_scores_dict, embeddings_dict, id_cls_scores_dict, pids, text_embeddings=None, pixels_cls_scores=None, target_masks=None, bpa_weight=0, reg_weight=10.0, ex_weight=10.0):
        # 1. ReID objective:
        ...
        if pixels_cls_scores is not None\
            ...
            loss += 0.35*bpa_weight * bpa_loss
            loss_summary = {**loss_summary, **bpa_loss_summary}
        # 3. Calculate the L_SCL_image loss
